...
class ExtensionCircleFragment : Fragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        next.setOnClickListener { (this@ExtensionCircleFragment.activity as ExtensionActivity).next() }
        previous.setOnClickListener { (this@ExtensionCircleFragment.activity as ExtensionActivity).previous() }
